...
class BaselineLevel:
    ...
    def get_template(cls, level: str) -> str:
        ...
        """
        resources_path = importlib.resources.files('trestle_fedramp.resources')
        data = {
            cls.LOW: str(resources_path.joinpath(FEDRAMP_APPENDIX_A_LOW)),
            cls.MODERATE: str(resources_path.joinpath(FEDRAMP_APPENDIX_A_MODERATE)),
            cls.HIGH: str(resources_path.joinpath(FEDRAMP_APPENDIX_A_HIGH))
        }
